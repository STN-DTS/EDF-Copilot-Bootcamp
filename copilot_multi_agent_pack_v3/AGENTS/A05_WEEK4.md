# A05_WEEK4 — Week 4 Linearization
...
- other weeks
- sprints
- runner/tasks/CI/global registry
...
4) Work log file at:
   `docs/maintainers/multi-agent/work-products/A05_WEEK4_WORKLOG.md`

## Objectives
- Apply standard lab template to every Week 4 lab.
- Add nav rails to Week 4 README + every lab.
- Fix internal links in Week 4.
- Embed P0–P3 prompt block and ensure Validate section exists.
