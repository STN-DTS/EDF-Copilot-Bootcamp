# A02_WEEK1 — Week 1 Linearization
...
4) Work log file at:
   `docs/maintainers/multi-agent/work-products/A02_WEEK1_WORKLOG.md`

## Objectives
- Apply standard lab template to every Week 1 lab.
- Add nav rails to Week 1 README + every lab.
- Fix internal links in Week 1.
