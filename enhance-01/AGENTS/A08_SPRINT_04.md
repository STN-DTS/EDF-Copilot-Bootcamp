# A08 — Sprint 04 — Docs + Packet Navigation + Step Metadata Sanity
...
1. Add navigation rails to:
   - `docs/content/sprint-04/README.md`
   - sprint program docs (e.g., `SPRINT_4_PROGRAM.md` if present)
   - sprint packet README(s) and task lists.

2. Ensure internal links resolve within your sprint folder after edits.

3. Validate `bootcamp/steps/sprint-04/*.yaml`:
